...
symptom onset as well as the delay between symptom onset and peak pathogen load. 
If time of peak pathogen load comes before time of symptom onset, meaning the 
calculated delay is negative, then by our definition, there is pre-symptomatic 
transmission. We also assess the correlation between pathogen replication rate 
