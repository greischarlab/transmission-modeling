...
# Panel A: Delay between symptom onset and peak viral shedding 
{
  ...
  segments(0.4, mean(noro.measures$delay_conservative, na.rm=T), 1.4,
           mean(noro.measures$delay_conservative, na.rm=T), col=noro.color,
           lwd=cex)
  
  segments(1.75, mean(sars.measures$delay_conservative, na.rm=T), 2.25,
...
{  
  ...
  #Average delays per pathogen
  segments(0.4, mean(noro.measures$delay_nonconservative, na.rm=T), 1.4,
           mean(noro.measures$delay_nonconservative, na.rm=T), col=noro.color,
           lwd=cex)
  
  segments(1.75, mean(sars.measures$delay_nonconservative, na.rm=T), 2.25,
