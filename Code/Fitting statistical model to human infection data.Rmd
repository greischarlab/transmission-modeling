...
participantexamples <- c('Throat_5', 'ID12', 'Throat_16')
...
noroParticipants <- unique(noro.FShedData[!(noro.FShedData$ID %in% c('ID20')),]$ID)
...
plot.fig3 <- function(delays, params.delays.data, 
  ...
  if (!nonconservative) {
    ...
    abline(lm.fit.p2.peaktime.noro, col=noro.color)
    ...
    abline(lm.fit.p2.symponset.noro, col=noro.color)
    ...
    legend(.6 * (xlim.e[2] - xlim.e[1]) + xlim.e[1], 
...
plot.fig3(
  ...
  lm.fit.b.noro = lm.fit.p2.delay.nonconservative.noro, 
