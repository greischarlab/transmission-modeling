...
# Fig 3B
lower.bound.delay.conservative.fit.noro <- c(quantile(delay.conservative.sample.slopes.noro, 0.025),
                                quantile(delay.conservative.sample.intercepts.noro, 0.025))

upper.bound.delay.conservative.fit.noro <- c(quantile(delay.conservative.sample.slopes.noro, 0.975), 
                                quantile(delay.conservative.sample.intercepts.noro, 0.975))

lower.bound.delay.conservative.fit.sars <- c(quantile(delay.conservative.sample.slopes.sars, 0.025),
                                quantile(delay.conservative.sample.intercepts.sars, 0.025))
                                
upper.bound.delay.conservative.fit.sars <- c(quantile(delay.conservative.sample.slopes.sars, 0.975),
                                quantile(delay.conservative.sample.intercepts.sars, 0.975))

# Fig S5B
lower.bound.delay.nonconservative.fit.noro <- c(quantile(delay.nonconservative.sample.slopes.noro, 0.025),
                                quantile(delay.nonconservative.sample.intercepts.noro, 0.025))

upper.bound.delay.nonconservative.fit.noro <- c(quantile(delay.nonconservative.sample.slopes.noro, 0.975), 
                                quantile(delay.nonconservative.sample.intercepts.noro, 0.975))

lower.bound.delay.nonconservative.fit.sars <- c(quantile(delay.nonconservative.sample.slopes.sars, 0.025),
                                quantile(delay.nonconservative.sample.intercepts.sars, 0.025))
                                
upper.bound.delay.nonconservative.fit.sars <- c(quantile(delay.nonconservative.sample.slopes.sars, 0.975),
...

{
  ...
  # Confidence bounds 
  noro.x <- noro.r.range
  noro.y.lower <- lower.bound.delay.conservative.fit.noro[1] * noro.x + lower.bound.delay.conservative.fit.noro[2]
  noro.y.higher <- upper.bound.delay.conservative.fit.noro[1] * noro.x + upper.bound.delay.conservative.fit.noro[2]
  ...
  sars.x <- sars.r.range
  sars.y.lower <- lower.bound.delay.conservative.fit.sars[1] * sars.x + lower.bound.delay.conservative.fit.sars[2]
  sars.y.higher <- upper.bound.delay.conservative.fit.sars[1] * sars.x + upper.bound.delay.conservative.fit.sars[2]
...

{
  ...
  # Confidence bounds 
  noro.y.lower <- (lower.bound.peakshedding.fit.noro[1]/24) * noro.x +
    (lower.bound.peakshedding.fit.noro[2]/24)
  noro.y.higher <- (upper.bound.peakshedding.fit.noro[1]/24) * noro.x +
    (upper.bound.peakshedding.fit.noro[2]/24)
  ...
  sars.y.lower <- (lower.bound.peakshedding.fit.sars[1]/24) * sars.x +
    (lower.bound.peakshedding.fit.sars[2]/24)
  sars.y.higher <- (upper.bound.peakshedding.fit.sars[1]/24) * sars.x +
    (upper.bound.peakshedding.fit.sars[2]/24)
...

{
  ...
  # Confidence bounds 
  noro.y.lower <- lower.bound.symponset.fit.noro[1] * noro.x + lower.bound.symponset.fit.noro[2]
  noro.y.higher <- upper.bound.symponset.fit.noro[1] * noro.x + upper.bound.symponset.fit.noro[2]
  
  polygon(c(rev(noro.x), noro.x), c(rev(noro.y.higher), noro.y.lower), 
          col = rgb(135, 26, 110, alpha=100,
                  maxColorValue=255), border = NA)
  
  sars.y.lower <- lower.bound.symponset.fit.sars[1] * sars.x + lower.bound.symponset.fit.sars[2]
  sars.y.higher <- upper.bound.symponset.fit.sars[1] * sars.x + upper.bound.symponset.fit.sars[2]
...

{
  ...
  noro.y.lower <- lower.bound.presymp.shed.avg.fit.noro[1] * noro.x + lower.bound.presymp.shed.avg.fit.noro[2]
  noro.y.higher <- upper.bound.presymp.shed.avg.fit.noro[1] * noro.x + upper.bound.presymp.shed.avg.fit.noro[2]
  ...
  sars.y.lower <- lower.bound.presymp.shed.avg.fit.sars[1] * sars.x + lower.bound.presymp.shed.avg.fit.sars[2]
  sars.y.higher <- upper.bound.presymp.shed.avg.fit.sars[1] * sars.x + upper.bound.presymp.shed.avg.fit.sars[2]
  ...
  
{
  ...
  # Confidence bounds 
  noro.x <- noro.r.range
  noro.y.lower <- lower.bound.delay.nonconservative.fit.noro[1] * noro.x + 
    lower.bound.delay.nonconservative.fit.noro[2]
  noro.y.higher <- upper.bound.delay.nonconservative.fit.noro[1] * noro.x + 
    upper.bound.delay.nonconservative.fit.noro[2]
  ...
  sars.x <- sars.r.range
  sars.y.lower <- lower.bound.delay.nonconservative.fit.sars[1] * sars.x + 
    lower.bound.delay.nonconservative.fit.sars[2]
  sars.y.higher <- upper.bound.delay.nonconservative.fit.sars[1] * sars.x + 
    upper.bound.delay.nonconservative.fit.sars[2]
...
plot.new()
{
  ...
  # Confidence bounds 
  noro.x <- noro.latency.range
  noro.y.lower <- lower.bound.presymp.shed.cum.fit.noro[1] * noro.x + lower.bound.presymp.shed.cum.fit.noro[2]
  noro.y.higher <- upper.bound.presymp.shed.cum.fit.noro[1] * noro.x + upper.bound.presymp.shed.cum.fit.noro[2]
  ...
  sars.x <- sars.latency.range
  sars.y.lower <- lower.bound.presymp.shed.cum.fit.sars[1] * sars.x + lower.bound.presymp.shed.cum.fit.sars[2]
  sars.y.higher <- upper.bound.presymp.shed.cum.fit.sars[1] * sars.x + upper.bound.presymp.shed.cum.fit.sars[2]
