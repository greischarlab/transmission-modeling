...
params.minsse <- function(fits) {
  ...
  minsse <- min(fits$sse)
  pars <- unlist((fits[fits$sse == minsse, ]))
  return(pars)
}
...
noro.fits.localmin$repRate <- exp(noro.fits.localmin$p2)
...
sars.fits.localmin$repRate <- exp(sars.fits.localmin$p2)
...
noro.r.range <- seq(log10(exp(min(noro.params.clearpeaks$p2))),
                    log10(exp(max(noro.params.clearpeaks$p2))),
                    length=n_points)

sars.r.range <- seq(log10(exp(min(sars.params.clearpeaks$p2))),
                    log10(exp(max(sars.params.clearpeaks$p2))),
                    length=n_points)
...
{
  xlim.bcd <- c(floor(min(log10(measures.combined[!measures.combined$ID %in% 
                                              c(noro.unclearpeaks, sars.unclearpeaks),]$repRate))) - 1,
              ceiling(max(log10(measures.combined[!measures.combined$ID %in% 
                                              c(noro.unclearpeaks, sars.unclearpeaks),]$repRate))) + 1)
  
  plot(symptomsToPeakDay ~ log10(repRate), data=measures.combined, 
   col=ifelse(pathogen == 'Norovirus', noro.color, sars.color),
   pch=ifelse(symptomsToPeakDay < 0 & pathogen == 'Norovirus', 17, 
                ifelse(symptomsToPeakDay > 0 & pathogen == 'Norovirus', 2,
                       ifelse(symptomsToPeakDay < 0 & pathogen == 'SARS-CoV-2', 23, 
...

{
  ...
  plot(peakDay ~ log10(repRate), data=measures.combined[!measures.combined$ID %in% 
                                              c(noro.unclearpeaks, sars.unclearpeaks),],
     col=ifelse(pathogen == 'Norovirus', noro.color, sars.color),
     xlim=xlim.bcd,
...

{
  ...
  plot(incubation ~ log10(repRate), data=measures.combined[!measures.combined$ID %in% 
                                              c(noro.unclearpeaks, sars.unclearpeaks),],
       col=ifelse(pathogen == 'Norovirus', noro.color, sars.color), 
...

{
  ...
  noro.epred <- transform(noro.pred, y_predicted = predict(transmission.presymp.avg.fit.noro, 
                                                          newdata=noro.epred))
...
{  
  ylim.ab <- c(floor(min(measures.combined[
    !measures.combined$ID %in% c(noro.unclearpeaks, sars.unclearpeaks),]$symptomsToStartShedding, na.rm=T))-1, 
               ceiling(max(measures.combined[
    !measures.combined$ID %in% c(noro.unclearpeaks, sars.unclearpeaks),]$symptomsToStartShedding, na.rm=T))+1)
  ...
  #Average delays per pathogen
  segments(0.3, mean(noro.params.localmin[noro.params.localmin$dose == .48 & 
                                     !noro.params.localmin$ID %in% noro.unclearpeaks,]$symptomsToStartShedding, 
                      na.rm=T), 0.5,
           mean(noro.params.localmin[noro.params.localmin$dose == .48 & 
                                     !noro.params.localmin$ID %in% noro.unclearpeaks,]$symptomsToStartShedding, 
                na.rm=T), col=noro.color,
           lwd=cex)
  
  segments(0.63, mean(noro.params.localmin[noro.params.localmin$dose == 4.8 & 
                                     !noro.params.localmin$ID %in% noro.unclearpeaks,]$symptomsToStartShedding, 
                      na.rm=T), 0.83,
           mean(noro.params.localmin[noro.params.localmin$dose == 4.8 & 
                                     !noro.params.localmin$ID %in% noro.unclearpeaks,]$symptomsToStartShedding, 
                na.rm=T), col=noro.color,
           lwd=cex)
  
  segments(0.967, mean(noro.params.localmin[noro.params.localmin$dose == 48 & 
                                     !noro.params.localmin$ID %in% noro.unclearpeaks,]$symptomsToStartShedding, 
                     na.rm=T), 1.167,
           mean(noro.params.localmin[noro.params.localmin$dose == 48 & 
                                     !noro.params.localmin$ID %in% noro.unclearpeaks,]$symptomsToStartShedding, 
  ...
  segments(1.3, mean(noro.params.localmin[noro.params.localmin$dose == 4800 & 
                                     !noro.params.localmin$ID %in% noro.unclearpeaks,]$symptomsToStartShedding, 
                     na.rm=T), 1.5,
           mean(noro.params.localmin[noro.params.localmin$dose == 4800 & 
                                     !noro.params.localmin$ID %in% noro.unclearpeaks,]$symptomsToStartShedding, 
                na.rm=T), col=noro.color,
           lwd=cex)
  
  segments(1.9, mean(sars.params.localmin[!sars.params.localmin$ID %in% sars.unclearpeaks,]
                     $symptomsToStartShedding, na.rm=T), 2.1,
           mean(sars.params.localmin[!sars.params.localmin$ID %in% sars.unclearpeaks,]
                $symptomsToStartShedding, na.rm=T), col=sars.color,
           lwd=cex)
...
{
  xlim.bcd <- c(floor(log10(min(measures.combined[!measures.combined$ID %in% 
                                              c(noro.unclearpeaks, sars.unclearpeaks),]$repRate))) - 1,
              ceiling(log10(max(measures.combined[!measures.combined$ID %in% 
                                              c(noro.unclearpeaks, sars.unclearpeaks),]$repRate))) + 1)
    
  plot(symptomsToStartShedding ~ log10(repRate), data=measures.combined[!measures.combined$ID %in% 
                                              c(noro.unclearpeaks, sars.unclearpeaks),], 
     col=ifelse(pathogen == 'Norovirus', noro.color, sars.color),
     pch=ifelse(symptomsToStartShedding < 0 & pathogen == 'Norovirus', 17, 
                  ifelse(symptomsToStartShedding > 0 & pathogen == 'Norovirus', 2,
...

{
  ...
  plot(sheddingOnset ~ log10(repRate), data=measures.combined[!measures.combined$ID %in% 
                                              c(noro.unclearpeaks, sars.unclearpeaks),],
     col=ifelse(pathogen == 'Norovirus', noro.color, sars.color),
     xlim=xlim.bcd,
     ylim=ylim.c, cex.axis=cex, cex=cex,
