...
ggplot(lowdose_full, aes(x=time, y=transmission_potential)) +
  geom_line() + facet_wrap(gamma~r, scales='free', labeller=labeller(gamma=gamma.labs, r=r.labs)) + 
  xlab("Time") + ylab("Transmission Potential") +
  theme(strip.background = element_rect(fill="lightblue"))

ggplot(meddose_full, aes(x=time, y=transmission_potential)) +
  geom_line() + facet_wrap(gamma~r, scales='free', labeller=labeller(gamma=gamma.labs, r=r.labs)) + 
  xlab("Time") + ylab("Transmission Potential") +
  theme(strip.background = element_rect(fill="lightblue"))

ggplot(highdose_full, aes(x=time, y=transmission_potential)) +
  geom_line() + facet_wrap(gamma~r, scales='free', labeller=labeller(gamma=gamma.labs, r=r.labs)) + 
  xlab("Time") + ylab("Transmission Potential") +
  theme(strip.background = element_rect(fill="lightblue"))
```
