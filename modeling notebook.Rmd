...
#MAPPED is a list
MAPPED <- mapply(desolve_function, gamma_r$gamma, gamma_r$r, id=1, SIMPLIFY = FALSE)

MAPPED_full <- do.call(rbind, MAPPED)
```

```{r}
ggplot(MAPPED_full, aes(x=time, y=transmission_potential)) +
  geom_line() + facet_grid(gamma~r)
```
