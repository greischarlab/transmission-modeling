...

{
  ...
  { 
    ...
    plot.simple.model.panel(symp.thresh1, k, datalow, datamed, datahigh, cols)
...
lowsymp.thresh.plot <- grid.arrange(varyingr.plot.lowthresh, varyingy.plot.lowthresh, ncol=2)

ggsave("./Figures/Varying r and y low thresh.png", plot=lowsymp.thresh.plot)

medsymp.thresh.plot <- grid.arrange(varyingr.plot.medthresh, varyingy.plot.medthresh, ncol=2)

ggsave("./Figures/Varying r and y med thresh.png", plot=medsymp.thresh.plot)

highsymp.thresh.plot <- grid.arrange(varyingr.plot.highthresh, varyingy.plot.highthresh, ncol=2)

ggsave("./Figures/Varying r and y high thresh.png", plot=highsymp.thresh.plot)
