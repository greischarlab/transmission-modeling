...

{
  ...
  { 
    ...
    plot.simple.model.panel(symp.thresh3, k, datalow, datamed, datahigh, cols)
...
}; plot.varyingr(delays.df.byr, symp.thresh3)
...
plot.varyinggamma <- function(delaysbygamma, symp.thresh) {
  ...
  theme(strip.background = element_rect(fill="lightblue"))
}; plot.varyinggamma(delays.df.bygamma, symp.thresh3)
```
